...
# Automatically keeps chromedriver up to date.
from webdriver_manager.chrome import ChromeDriverManager  # pip install webdriver-manager
chrome_driver_path = ChromeDriverManager(path="PATH HERE").install()
